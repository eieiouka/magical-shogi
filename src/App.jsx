...
const PIECE_GUIDES={
 ema:{move:"8方向に1マス移動できます。",magicName:"魔女殺し",magic:"相手側の最下段へ到達すると、成って相手のエマを捕獲できます（勝利）。"},
 nanoka:{move:"通常時は前・左右に1マス。魔女化後は8方向に1マス移動できます。",magicName:"銃撃",magic:"前方2マス、斜め前2マスの敵を銃撃します。間に駒がある場合は撃てません。"},
 hanna:{move:"通常時は前・斜め前に1マス。魔女化後は8方向に1マス移動できます。",magicName:"浮遊",magic:"前方へ2マス移動できます。間の駒は飛び越えられ、着地先の駒は取れません。"},
