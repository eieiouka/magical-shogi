...
struct Variant {
  ...
  // Magical Shogi uses SPECIAL moves whose capture square can differ from the
  // destination (or whose moving piece intentionally stays on its source).
  bool magicalShogi = false;
