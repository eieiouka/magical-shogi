...
function __mmap_js(len, prot, flags, fd, offset, allocated, addr) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(7, 0, 1, len, prot, flags, fd, offset, allocated, addr);
...
function __munmap_js(addr, len, prot, flags, fd, offset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(8, 0, 1, addr, len, prot, flags, fd, offset);
  offset = bigintToI53Checked(offset);
  try {
    var stream = SYSCALLS.getStreamFromFD(fd);
    if (prot & 2) {
...
function __setitimer_js(which, timeout_ms) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(9, 0, 1, which, timeout_ms);
...
function _emscripten_force_exit(status) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(10, 0, 1, status);
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_ioctl, ___syscall_openat, __mmap_js, __munmap_js, __setitimer_js, _emscripten_force_exit, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write ];
...
var _malloc, _free, _main, __emscripten_tls_init, _pthread_self, _emscripten_builtin_memalign, __emscripten_proxy_main, __emscripten_thread_init, ___set_thread_state, __emscripten_thread_crashed, __emscripten_run_js_on_main_thread_done, __emscripten_run_js_on_main_thread, __emscripten_thread_free_data, __emscripten_thread_exit, __emscripten_timeout, __emscripten_check_mailbox, _emscripten_stack_set_limits, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_ii, dynCall_vi, dynCall_iii, dynCall_v, dynCall_vii, dynCall_iidiiiii, dynCall_jiji, dynCall_iiii, dynCall_viijii, dynCall_viiii, dynCall_iiiii, dynCall_iiiiii, dynCall_iiiiiiiii, dynCall_iiiiiii, dynCall_iiiiij, dynCall_iiiiid, dynCall_iiiiijj, dynCall_iiiiiiii, dynCall_iiiiiijj, dynCall_viiiiii, dynCall_viiiii, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, __indirect_function_table;

function assignWasmExports(wasmExports) {
  _malloc = wasmExports["J"];
  _free = wasmExports["K"];
  _main = Module["_main"] = wasmExports["L"];
  __emscripten_tls_init = wasmExports["M"];
  _pthread_self = wasmExports["N"];
  _emscripten_builtin_memalign = wasmExports["O"];
  __emscripten_proxy_main = Module["__emscripten_proxy_main"] = wasmExports["P"];
  __emscripten_thread_init = wasmExports["Q"];
  ___set_thread_state = wasmExports["R"];
  __emscripten_thread_crashed = wasmExports["S"];
  __emscripten_run_js_on_main_thread_done = wasmExports["T"];
  __emscripten_run_js_on_main_thread = wasmExports["U"];
  __emscripten_thread_free_data = wasmExports["V"];
  __emscripten_thread_exit = wasmExports["W"];
  __emscripten_timeout = wasmExports["X"];
  __emscripten_check_mailbox = wasmExports["Y"];
  _emscripten_stack_set_limits = wasmExports["Z"];
  __emscripten_stack_restore = wasmExports["_"];
  __emscripten_stack_alloc = wasmExports["$"];
  _emscripten_stack_get_current = wasmExports["aa"];
  dynCall_ii = dynCalls["ii"] = wasmExports["ba"];
  dynCall_vi = dynCalls["vi"] = wasmExports["ca"];
  dynCall_iii = dynCalls["iii"] = wasmExports["da"];
  dynCall_v = dynCalls["v"] = wasmExports["ea"];
  dynCall_vii = dynCalls["vii"] = wasmExports["fa"];
  dynCall_iidiiiii = dynCalls["iidiiiii"] = wasmExports["ga"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["ha"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["ia"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["ja"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["ka"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["la"];
  dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["ma"];
  dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["na"];
  dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["oa"];
  dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["pa"];
  dynCall_iiiiid = dynCalls["iiiiid"] = wasmExports["qa"];
  dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["ra"];
  dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["sa"];
  dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["ta"];
...
function assignWasmImports() {
  wasmImports = {
    /** @export */ z: ___pthread_create_js,
    /** @export */ f: ___syscall_fcntl64,
    /** @export */ m: ___syscall_fstat64,
    /** @export */ v: ___syscall_ioctl,
    /** @export */ j: ___syscall_openat,
    /** @export */ n: __abort_js,
    /** @export */ F: __emscripten_init_main_thread_js,
    /** @export */ x: __emscripten_notify_mailbox_postmessage,
    /** @export */ i: __emscripten_receive_on_main_thread_js,
    /** @export */ q: __emscripten_runtime_keepalive_clear,
    /** @export */ g: __emscripten_thread_cleanup,
    /** @export */ E: __emscripten_thread_mailbox_await,
    /** @export */ e: __emscripten_thread_set_strongref,
    /** @export */ C: __mmap_js,
    /** @export */ D: __munmap_js,
    /** @export */ r: __setitimer_js,
    /** @export */ s: __tzset_js,
    /** @export */ B: _clock_time_get,
    /** @export */ h: _emscripten_check_blocking_allowed,
    /** @export */ G: _emscripten_exit_with_live_runtime,
    /** @export */ A: _emscripten_force_exit,
    /** @export */ c: _emscripten_get_now,
    /** @export */ w: _emscripten_resize_heap,
    /** @export */ o: _emscripten_runtime_keepalive_check,
    /** @export */ H: emscripten_utils_getline_impl,
